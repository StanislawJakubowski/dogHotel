    ...
    <nav class="x-navbar navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="nav nounderline text-uppercase">
            <li class="nav-item ml-4">
                <a class="nav-link color-header btn btn-secondary" href="/users/dogs/list">moje psy</a>
            </li>
            <li class="nav-item ml-4">
                <a class="nav-link color-header btn btn-secondary" href="/users/bookings/add">dodaj pobyt w hotelu</a>
            </li>
            <li class="nav-item ml-4">
                <a class="nav-link color-header btn btn-secondary" href="/#">koko</a>
            </li>
            <li class="nav-item ml-4">
